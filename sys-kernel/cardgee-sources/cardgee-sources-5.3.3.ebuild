...
DESCRIPTION="cardgee-sources is a fork of the linux kernel with some extra features including MuQSS futex and Gentoo's genpatches"

SRC_URI="https://github.com/CarDGee/linux/archive/5.3.3-cardgee.tar.gz"

src_unpack() {
	tar -xf ${DISTDIR}/5.3.3-cardgee.tar.gz
}
